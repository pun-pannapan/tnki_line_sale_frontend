...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, formdata, fileId, index, vUrl) {
            ...
            defaults = {
                ...
                dataType: 'json',
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem('EUCERIN:TBC:TOKEN')
                },
                data: formdata,
                cache: false,
                processData: false,
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn  btn-outline-gray my-1 w-100',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn btn-danger btn-animate my-1 w-100',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-primary btn-animate my-1 w-75',
        ...
        dropZoneTitleClass: 'file-upload-wrapper',
        fileActionSettings: {},
        otherActionButtons: '',
        textEncoding: 'UTF-8',
