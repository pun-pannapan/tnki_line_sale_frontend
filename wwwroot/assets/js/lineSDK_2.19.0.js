    ...
    return function (e) {
        ...
        i = [], void 0 === (o = "function" == typeof (r = function () {
            var e = function e(t) {
                ...
                for (var r, i, o = Math.pow, a = o(2, 32), s = "", c = [], u = 8 * t.length, l = e.h = e.h || [], f = e.k = e.k || [], d = f.length, p = {}, h = 2; d < 64; h++)
                    if (!p[h]) {
                ...
                for (c[c.length] = u / a | 0, c[c.length] = u, i = 0; i < c.length;) {
                    ...
                    for (l = l.slice(0, 8), r = 0; r < 64; r++) {
                        var w = v[r - 15],
                            ...
                            g = l[0],
                            b = l[4],
                            _ = l[7] + (n(b, 6) ^ n(b, 11) ^ n(b, 25)) + (b & l[5] ^ ~b & l[6]) + f[r] + (v[r] = r < 16 ? v[r] : v[r - 16] + (n(w, 7) ^ n(w, 18) ^ w >>> 3) + v[r - 7] + (n(m, 17) ^ n(m, 19) ^ m >>> 10) | 0);
                        (l = [_ + ((n(g, 2) ^ n(g, 13) ^ n(g, 22)) + (g & l[1] ^ g & l[2] ^ l[1] & l[2])) | 0].concat(l))[4] = l[4] + _ | 0
                    }
        ...
        }, m.call(b.prototype), m.call(I.prototype), I.prototype.clone = function () {
        ...
        function O(e, t) {
            return new Promise((function (n, r) {
                ...
                }, a.open(i.method, i.url, !0), "include" === i.credentials ? a.withCredentials = !0 : "omit" === i.credentials && (a.withCredentials = !1), "responseType" in a && o && (a.responseType = "blob"), i.headers.forEach((function (e, t) {
        ...
        O.polyfill = !0, self.fetch || (self.fetch = O, self.Headers = p, self.Request = b, self.Response = I);
        n(7);
        var A = function (e, t) {
        ...
        function C() {
            if (!k) {
                ...
                k = /iphone|ipad|ipod/.test(e) ? "ios" : /android/.test(e) ? "android" : "web"
            }
            return k
        }
        ...
        var j = "INIT_FAILED",
            ...
            F = ["context_token", "feature_token", "access_token", "id_token", "client_id"],
            U = ["openWindow", "closeWindow"];
        var M = null;

        function B() {
            var e;
            return null === M && (void 0 === e && (e = window.navigator.userAgent), M = /Line\/\d+\.\d+\.\d+ LIFF/.test(e) || function (e) {
                return void 0 === e && (e = window.navigator.userAgent), /Line\/\d+\.\d+\.\d+/.test(e)
            }() && /[#|&]access_token=/.test(location.hash) || "1" === sessionStorage.getItem(L + ":isInClient"), sessionStorage.setItem(L + ":isInClient", M ? "1" : "0")), !!M
        }
        ...
        function G(e) {
            return function (e, t) {
                if (!t) throw q("INVALID_CONFIG", "liffId is necessary for liff.init()");
        ...
        function K(e, t) {
            var n = $().liffId;
            if (!n) throw q("INVALID_CONFIG", "liffId is necessary for liff.init()");
            ...
            X = {
                ...
                clean: function () {
                    ...
                    Object.keys(x).forEach((function (e) {
                        H(x[e])
                    })), e = $(), J.remove(L + ":" + x.EXPIRES + ":" + e.liffId, {
                        path: "/"
                    })
                }
            },
        ...
        var ve = {
            ...
            we = function () {
                ...
                if (!e.endpointUrl) throw q(j, "Could not get endpointUrl from server.");
                if (!e.permanentLinkPattern) throw q(j, "Could not get permanentLinkPattern from server.");
                return e
            };
        ...
        function Ee(e) {
            for (var t = "", n = 0; n < e; n++) t += Ie[Math.floor(window.crypto.getRandomValues(new Uint32Array(1))[0] / 4294967296 * Ie.length)];
            return t
        }
        ...
        function Ne(e) {
            var t = Ee(43),
                n = _e(t),
                r = $();
            if (!r || !r.liffId) throw q("INVALID_CONFIG", "You need to define `liffId` for liff.login()");
            var i = {
                app_id: r.liffId,
                state: Ee(12),
                response_type: "code",
            ...
            e && e.redirectUri && (i.redirect_uri = e.redirectUri), K(x.LOGIN_TMP, {
                codeVerifier: t
            });
        ...
        function Ce(e, t) {
            Se || (Se = !0, window.addEventListener("liffEvent", (function (e) {
                e && e.detail && e.detail.type && Pe[e.detail.type] && Pe[e.detail.type].forEach((function (t) {
                    return t(e)
                }))
                ...
                return S(this, (function (i) {
                    switch (i.label) {
                        ...
                        case 3:
                            return i.sent(), [2, e];
                        case 4:
                            return t = String(e.status), n = V.has(t) ? t : "UNKNOWN", [4, e.json().catch((function () {
                                throw q(n, e.statusText)
                            }))];
                        case 5:
                            throw q((r = i.sent()).error || n, r.error_description || r.message)
                    }
                }))
            }))
        }
        ...
        function Me(e) {
            var t = function (e) {
                if (e) return e;
                var t = te();
                if (!t) throw q("UNAUTHORIZED", "Need access_token for api call, Please login first");
                return {
        ...
        var Ve = function () {
            ...
            We = function () {
                return "ios" === C() && (null !== (e = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)) && parseInt(e[1], 10) <= 10);
                var e
            };
        ...
        function qe(e, t, r) {
            return P(this, void 0, void 0, (function () {
                ...
                return S(this, (function (c) {
                    switch (c.label) {
                        case 0:
                            return We() ? [4, Promise.all([n.e(2), n.e(0)]).then(n.t.bind(null, 243, 7))] : [3, 2];
                        case 1:
                            return o = c.sent(), a = o.default, i = a.verify(t, r, e, "SHA-256", "raw"), [3, 5];
                        case 2:
                        ...
                        case 3:
                            return s = c.sent(), [4, crypto.subtle.verify({
                                name: "ECDSA",
                                hash: {
                                    name: "SHA-256"
                                }
        ...
        function Ge(e, t) {
            return P(this, void 0, void 0, (function () {
                ...
                return S(this, (function (y) {
                    switch (y.label) {
                        case 0:
                            return n = e.split("."), r = n[0], i = n[1], o = n[2], a = JSON.parse(xe(r)), s = JSON.parse(xe(i)), c = Fe(xe(o)), u = Fe(r + "." + i), [4, Ve()];
                        case 1:
                            if (l = y.sent(), !(f = l.keys.find((function (e) {
                                return e.kid === a.kid
                            })))) return [3, 6];
                            if (delete f.alg, "ES256" !== a.alg) throw q("INVALID_ID_TOKEN", 'Invalid "alg" value in ID_TOKEN');
                            d = void 0, y.label = 2;
                        case 2:
                        ...
                        case 3:
                            return d = y.sent(), [3, 5];
                        case 4:
                            throw q("INVALID_ID_TOKEN", "Failed to use Crypto API to verify ID_TOKEN: " + y.sent());
                        case 5:
                            if (d) {
                                if (p = "https://access.line.me" !== s.iss, h = s.aud !== t, v = 1e3 * s.exp < Date.now(), p) throw q("INVALID_ID_TOKEN", 'Invalid "iss" value in ID_TOKEN');
                                if (h) throw q("INVALID_ID_TOKEN", 'Invalid "aud" value in ID_TOKEN');
                                if (v) throw q("INVALID_ID_TOKEN", 'Invalid "exp" value in ID_TOKEN');
                                return [2, s]
                            }
        ...
        function He(e) {
            ...
            return P(this, void 0, void 0, (function () {
                var e, r;
                return S(this, (function (i) {
                    return e = n ? "?" + he(n) : "", r = "" + Ke.LIFF_CUSTOM_URL_SCHEME + t + e, location.href = r, [2]
                }))
            }))
        }
        var Je = ["shareTargetPicker", "multipleLiffTransition"],
            ...
            ze = function (e) {
                if (!Je.includes(e)) throw q("INVALID_ARGUMENT", "Unexpected API name.");
                var t = Xe[e];
                return !t || t()
            };
        ...
        function $e(e, t) {
            return P(this, void 0, void 0, (function () {
                return S(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            return ze("multipleLiffTransition") ? [4, Promise.all([new Promise((function (e, t) {
                                Ce("liffIdReceived", (function n(r) {
                                    De("liffIdReceived", n), r.detail.data && r.detail.data.result ? e() : t(q(j))
                                }))
                            })), He({
                                pathname: "app/" + e,
                                query: {
        ...
        function Ze() {
            return !!Boolean(G(x.IS_SUBSEQUENT_LIFF_APP)) || !(!B() || ve.parse(window.location.hash).feature_token || se()) && (K(x.IS_SUBSEQUENT_LIFF_APP, !0), !0)
        }

        function et() {
            "boolean" == typeof Ye && function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                var n = console.warn;
                n.apply(void 0, e)
            }("liff.init is not expected to be called more than once"), Ye = Ze()
        }
        ...
        function rt(e) {
            return P(this, void 0, void 0, (function () {
                ...
                return S(this, (function (c) {
                    switch (c.label) {
                        case 0:
                            return t = ve.parse(window.location.hash), n = function (e) {
                            ...
                            }, t), tt() ? fe() ? [4, nt(e)] : [3, 2] : [3, 3];
                        case 1:
                            i = c.sent(), o = i.featureToken, a = i.features, r = a, n.feature_token || (n.feature_token = o), c.label = 2;
                        case 2:
                            (s = function (e) {
                                var t = e.match(/([^-]+)-[^-]+/);
                                return t && t[1]
                            }(e)) && (n.client_id = s), c.label = 3;
                        case 3:
                            return [2, {
                                credentials: n,
                                features: r
        ...
        function it(e) {
            if (e.persisted && ze("multipleLiffTransition"))
                if ("ios" === C()) window.location.reload();
                    ...
                    if (!n) throw q("FORBIDDEN", "Invalid featureToken for client features");
                    He({
                        pathname: "app/" + t,
                        query: {
                            feature_token: n
                    ...
                    switch (f.label) {
                        case 0:
                            return [4, new Promise((function (e) {
                                ...
                                else if (window._liff && window._liff.features) Y(window._liff.features), e();
                                else {
                                    var n = function (t) {
                                        De("ready", n), t && t.detail && t.detail.data && t.detail.data.features && Y(t.detail.data.features), e()
                                    };
                                    Ce("ready", n)
                                }
                            }))];
                        ...
                        case 2:
                            return t = f.sent(), n = t.credentials, r = n.access_token, i = n.context_token, o = n.feature_token, a = n.id_token, s = n.client_id, c = t.features, o ? [4, $e(e.liffId, o)] : [3, 4];
                        case 3:
                            f.sent(), tt() && ce(o), f.label = 4;
                        case 4:
                            return u = "function" == typeof window._liff.validateFeatureToken, i && le(Le(i)), window.addEventListener("pageshow", it), tt() && Y(c || U), fe() ? [3, 8] : o && r ? [3, 7] : (Ne(tt() ? {
                                redirectUri: location.href
                            } : void 0), tt() ? [4, new Promise((function () { }))] : [3, 6]);
                        case 5:
                            f.sent(), f.label = 6;
                        case 6:
                        ...
                        case 7:
                            ...
                            }(e.liffId, o)) throw Ne(), q(j, "Failed to validate feature_token");
                            !u && window.history.length > 1 ? je("potential abuser") : (ce(o), ne(r)), f.label = 8;
                        case 8:
                            return a && !re() && ie(a), a && s && !oe() ? [4, Ge(a, s)] : [3, 10];
                        case 9:
        ...
        function at(e) {
            return P(this, void 0, void 0, (function () {
                ...
                return S(this, (function (c) {
                    switch (c.label) {
                        case 0:
                            return t = Ae("apps"), n = t + "/" + e + "/contextToken", r = te(), i = {
                                "Content-Type": "application/json",
                                Accept: "application/json"
                            }, r && (i.Authorization = "Bearer " + r), [4, Be(n, {
                                headers: i
                            })];
                        case 1:
                            if (o = c.sent(), !(a = o.contextToken)) throw q(j, "Can not get context from server.");
                            ...
                            t = function () {
                                return P(i, void 0, void 0, (function () {
                                    ...
                                    return S(this, (function (s) {
                                        switch (s.label) {
                                            case 0:
                                                return [4, (c = $(), u = ve.parse(window.location.search), l = Z(), f = {
                                            ...
                                            case 1:
                                                return t = s.sent(), n = t.access_token, r = t.id_token, i = t.expires_in, ne(n),
                                                    function (e) {
                                                        var t = $();
                                                        J.set(L + ":" + x.EXPIRES + ":" + t.liffId, e.getTime(), {
                                                            expires: e.toUTCString(),
                                                            path: "/",
                                                            secure: null
                                                        })
                                                    }(new Date(Date.now() + 1e3 * i)), ee(), r ? (ie(r), [4, Ge(r, e)]) : [3, 3];
                                            case 2:
                                                (o = s.sent()) && ae(o), s.label = 3;
                                            case 3:
                                                return (a = ve.parse(location.hash).context_token) ? (le(Le(a)), [3, 6]) : [3, 4];
                                            case 4:
                                                return [4, st()];
                                            case 5:
                                                s.sent(), s.label = 6;
        ...
        function ut(e) {
            return P(this, void 0, void 0, (function () {
                ...
                return S(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            if (!e.liffId) throw q("INVALID_CONFIG", "liffId is necessary for liff.init()");
                            if (z = e, (t = ve.parse(window.location.search)).error && t.liffOAuth2Error) throw o = t.error, a = t.error_description, s = a.replace(/\+/g, " "), q(j, o + ": " + s);
                            return r = t.code, i = Z(), Boolean(r && !fe() && i && i.codeVerifier) ? [4, ct(t.liffClientId)] : [3, 2];
                        case 1:
                            n.sent(), n.label = 2;
                        case 2:
                            return B() ? [4, ot(e)] : [3, 4];
                        ...
                        case 5:
                            n.sent(), n.label = 6;
                        case 6:
                            return t["liff.state"] && me(t["liff.state"]), B() || !fe() ? [2] : (de() && pe(), [2])
                    }
                    var r, i, o, a, s
                }))
            }))
        ...
        function ft() {
            var e;
            return "ios" === C() ? (e = R()) && D(e, "9.19.0") < 0 ? "https://static.line-scdn.net/liff/edge/2/ios-918-extensions.js" : "https://static.line-scdn.net/liff/edge/2/ios-extensions.js" : "https://static.line-scdn.net/liff/edge/2/non-ios-extensions.js"
        }
                        ...
                        case 2:
                            return [2, new Promise((function (e, t) {
                                ...
                                n.onload = function () {
                                    ...
                                    n ? e(n) : t(q(j, "Unable to load client features. (Extension is empty)"))
                                }, n.onerror = function () {
        ...
        function ht(e, t, n) {
            return Promise.all([pt(this), ut(e)]).then((function () {
        ...
        function vt(e, t, n) {
            ...
            var r = se();
            if (!r) throw q("FORBIDDEN", "Invalid featureToken for client features");
            if (!window._liff || !window._liff.postMessage) throw q("INVALID_ARGUMENT", "postMessage is not available from client");
            ...
            return void 0 === t && (t = {}), void 0 === n && (n = {
                ...
                var o = function (t) {
                    if (t && t.detail) {
                        ...
                        (a || s) && (n.once && De(e, o), t.detail.error ? i(t.detail.error) : t.detail.data ? r(t.detail.data) : i(t.detail))
                    }
                    i()
                };
                Ce(e, o), vt(e, t, n.callbackId)
            }))) : Promise.reject(q("FORBIDDEN", "Invalid featureToken for client features"))
        }
        var wt = function (e) {
        ...
        function Tt(e, t, n, r) {
            if (void 0 === n && (n = {}), "object" != typeof e || !e.postMessage) throw q("INVALID_ARGUMENT", "target must be window object");
            if ("string" != typeof t) throw q("INVALID_ARGUMENT", "keyname must be string");
            if ("object" != typeof n) throw q("INVALID_ARGUMENT", "incorrect body format. It should be Object or Array comprised of Object");
            if (!r) throw q("INVALID_ARGUMENT", "serverEndPointUrl isn't passed. please fill up with proper url");
            if ("development" !== Ke.ENV && "*" === r) throw new Error("serverEndPointUrl doesn't allow to set '*'");
            var i = {
                name: t,
                body: n
            };
        ...
        function Ot(e, t) {
            var n;
            Et(window, "message." + (n = "receivedHealthcheck"), function (e, t, n) {
                return function (r) {
        ...
        var At = function () {
            ...
            return e.getInstance = function () {
                ...
                var e, t;
                this.abortController && this.abortController.abort(), B() || (e = this.timeoutIDForHealthCheck, t = this.popupWindow, gt(window, "message.receivedHealthcheck"), e && clearTimeout(e), t && !t.closed && t.close())
                ...
                return void 0 === e && (e = Ae("shareTargetPicker")),
                    function (e) {
                        var t = e.match(/^(https?:\/\/.*?)\//);
                        return t && t[1] || ""
                    }(e)
                ...
                return P(this, void 0, void 0, (function () {
                    ...
                    return S(this, (function (r) {
                        switch (r.label) {
                            case 0:
                                return this.abortController && (e = this.abortController.signal), t = Ae("shareTargetPickerOtt") + "/" + this.liffId + "/ott", n = this, [4, Be(t, {
                                    method: "GET",
                                    signal: e
                                }).then((function (e) {
                                    return e.ott
                ...
                var e;
                B() || ("ios" !== C() || (void 0 === e && (e = window.navigator.userAgent), /ipad/.test(e.toLowerCase())) ? this.popupWindow = window.open("", "liffpopup", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : this.popupWindow = window.open())
                ...
                }, location.href = Ke.SHARE_TARGET_PICKER_SCHEME_URL + "?" + he(r);
                else {
                    if (this.timeoutIDForHealthCheck = window.setTimeout(this.healthCheck.bind(this), 1e3), !this.popupWindow) throw q("CREATE_SUBWINDOW_FAILED");
                    ! function (e, t, n) {
                        var r = {
                            liffId: t,
                            ott: n
                ...
                B() || Ot(this.onReceivedHealthcheck.bind(this), this.allowPostMessageOrigin)
                    ...
                    return S(this, (function (t) {
                        switch (t.label) {
                            ...
                            case 6:
                                return [3, 8];
                            case 7:
                                n = this.popupWindow, r = this.allowPostMessageOrigin, Tt(n, "healthcheck", void 0, r), this.timeoutIDForHealthCheck = window.setTimeout(this.healthCheck.bind(this), 1e3), t.label = 8;
                            case 8:
                                return [2]
                        }
                        var n, r
                ...
                if (!this.popupWindow || !this.payloadToShareTargetPicker) throw q("CREATE_SUBWINDOW_FAILED");
                var e, t, n;
                e = this.popupWindow, t = this.payloadToShareTargetPicker, n = this.allowPostMessageOrigin, Tt(e, "ready", t, n)
                        ...
                        switch (n.label) {
                            case 0:
                                ...
                                return this.abortController && (e = this.abortController.signal), t = {
                                    liffId: this.liffId,
                                    ott: this.ott
                                }, [4, Be(Ae("shareTargetPickerResult") + "?" + he(t), {
                                    method: "POST",
                                    signal: e,
                                    headers: {
                                        Accept: "application/json",
                ...
                return P(this, void 0, void 0, (function () {
                    ...
                    return S(this, (function (n) {
                        ...
                        return this.abortController && (e = this.abortController.signal), t = {
                            liffId: this.liffId,
                            ott: this.ott
                        }, [2, Be(Ae("shareTargetPickerResult") + "?" + he(t), {
                            method: "GET",
                            headers: {
                                Accept: "application/json"
                            },
        ...
        var kt = {
            ...
            openWindow: function (e) {
                ...
                }(e)) throw q("INVALID_ARGUMENT", "Invalid parameters for liff.openWindow()");
                if (B())
                    if (window._liff.postMessage) yt("openWindow", e);
                        ...
                        window.open(function (e, t) {
                            var n = e.split("?"),
                                ...
                                a = o[0],
                                s = o[1];
                            return r + "?is_liff_external_open_window=" + !!t + (a ? "&" + a.split("&").map(decodeURIComponent).filter((function (e) {
            ...
            closeWindow: function () {
                if (window._liff && window._liff.postMessage) {
                    var e = R();
                    null !== e && D(e, "10.15.0") >= 0 ? "ios" === C() ? window._liff.postMessage("closeWindow", "") : window._liff.postMessage("closeWindow", "", "", "") : yt("closeWindow")
                } else window.close()
            },
            getFeatures: Q,
            ...
            sendMessages: function (e) {
                ...
                }(e)) return mt("Parameter 'messages' must be an array of { type, ... }");
                var t = e.length;
                return t < 1 || t > 5 ? mt("Number of messages should be in range 1 to 5.") : Be(Ae("message"), {
                    method: "POST",
                    body: JSON.stringify({
                        messages: e
                    })
            ...
            shareTargetPicker: function (e) {
                return P(this, void 0, void 0, (function () {
                    ...
                    return S(this, (function (f) {
                        switch (f.label) {
                            case 0:
                                if (t = (ue() || {}).availability, n = (t || {}).shareTargetPicker, i = (r = n || {}).permission, o = r.minVer, !i) throw B() ? q("FORBIDDEN", "Need LINE App " + o + " at least or consent on shareTargetPicker usage on LINE developer site") : q("FORBIDDEN", "Need consent on shareTargetPicker usage on LINE developer site");
                                if (!fe()) throw q("UNAUTHORIZED", "Need access_token for api call, Please login first");
                                if (!e || !Array.isArray(e) || 0 === e.length) throw q("INVALID_ARGUMENT", "no proper argument");
                                if (e.length > 5) throw q("INVALID_ARGUMENT", "exceed the limit of num of messages");
                                if (!(a = $().liffId)) throw q("INVALID_CONFIG");
                                f.label = 1;
                            case 1:
                                return f.trys.push([1, 3, , 4]), s = At.getInstance(), c = R(), u = {
                                    waitForSubwindowResult: !0
                                }, B() && c && D(c, "10.11.0") < 0 && (u.waitForSubwindowResult = !1), [4, s.init({
                                    messages: e,
                                    referrer: {
                                        liffId: a,
                                        url: location.origin
                            ...
                            case 2:
                                return [2, f.sent()];
                            case 3:
                                throw (l = f.sent()) instanceof W ? l : q("EXCEPTION_IN_SUBWINDOW", l.message);
                            case 4:
                                return [2]
                        }
                    }))
            ...
            permanentLink: {
                createUrl: function () {
                    ...
                    if (a.origin !== o || ! function (e, t) {
                        return 0 === t.indexOf(e) && (e.endsWith("/") && (e = e.substring(0, e.length - 1)), void 0 === t[e.length] || "/" === t[e.length])
                    }(a.pathname, n)) throw q("INVALID_CONFIG", "Current page is not under entrypoint.");
                    ...
                    var w = d.join("&"),
                        m = s + ("" !== w ? "?" + w : "") + (l ? "#" + l : "");
                    return "replace" === e.permanentLinkPattern && "" !== m && (m = "" + n + r + (l ? "#" + l : "")), "https://liff.line.me/" + $().liffId + m
                },
